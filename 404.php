...
<img class="image-404" src="img/404.png" width="300px">

    <?php
        if(isset($_GET["hata"])){
            $hata = $_GET["hata"];
            echo '<h2 style="color: white;">'.$hata.'</h2>';
        }
        else{
            echo '<h2 style="color: white;">Görünüşe göre bir şeyler yanlış gitti.</h2>';
        }
        if(isset($_GET["kod"])){
            $kod = $_GET["kod"];
            echo '<h3 style="color: white;">Hata Nedeni: '.$kod.'</h3>';
        }
    ?>
<br><a href="index.php" class="btn-go-home">ANASAYFA</a>
</div>
<div class="objects">
