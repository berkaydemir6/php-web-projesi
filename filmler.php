...
$query = 'SELECT arkaplan FROM icerik WHERE tur = "Film" ORDER BY RAND() LIMIT 1';
...
<head>
    ...
    <title>Filmler - İçerik Veritabanım</title>
...
$query = "SELECT * FROM icerik WHERE tur = 'Film' ORDER BY id DESC";
$result = mysqli_query($link, $query) or die(mysqli_error($link));
$i = 0;
